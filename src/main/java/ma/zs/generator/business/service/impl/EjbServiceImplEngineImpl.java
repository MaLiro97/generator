 ...
 */
@Service
public class EjbServiceImplEngineImpl implements ServiceImplEngine {
    ...
    public String generateFindById(Pojo pojo) {
        ...
        String resultat = ServiceImplConfig.getOverride()
                ...
                + ServiceImplConfig.getDaoSuffix() +"."+ ServiceImplConfig.getFindByPrefix()+ StringFormatterUtil.upperCaseTheFirstLetter(pojo.getIdName())+"(" + pojo.getIdName() + ");\n"
                + "}\n";
        return resultat;
    ...
    public String generateFindByCriteria(Pojo pojo) {
        ...
        return " @Override \n "
                ...
                + "{\n"
                + " return " + classNameLowerCase+ServiceImplConfig.getDaoSuffix()+ "."+ServiceImplConfig.getFindByCriteriaMethodeName()+"("+ generateValues(pojo)+"); \n "
                + "}\n";
    }
